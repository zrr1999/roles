...
name: verifier
description: >-
  Use for targeted validation: repro, diagnostics, regression checks, and code
  review against a named claim or change. Optional review lenses (security,
  performance, architecture) specialize the checklist—set lens on the brief.
role: subagent
model:
  tier: coding
capabilities:
